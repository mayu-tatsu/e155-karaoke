# 0 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
# 1 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
# 30 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
# 31 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c" 2
...
# 77 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
void arm_cfft_radix4_q15(
  const arm_cfft_radix4_instance_q15 * S,
        q15_t * pSrc)
{
...
# 147 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
void arm_radix4_butterfly_q15(
        q15_t * pSrc16,
        uint32_t fftLen,
  const q15_t * pCoef16,
        uint32_t twidCoefModifier)
{
  ...
  do
  {
    ...
    out2 = __SMUSDX(C2, R);
# 257 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    T = read_q15x2 (pSi1);
    T = __SHADD16(T, 0);
    T = __SHADD16(T, 0);
    ...
    S = __QSAX(S, T);
# 287 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    ...
    out2 = __SMUSDX(C1, S);
# 303 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    ...
    out2 = __SMUSDX(C3, R);
# 322 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
# 336 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  twidCoefModifier <<= 2U;
  ...
  for (k = fftLen / 4U; k > 4U; k >>= 2U)
  {
    ...
    for (j = 0U; j <= (n2 - 1U); j++)
    {
      ...
      for (i0 = j; i0 < fftLen; i0 += n1)
      {
        ...
        out2 = __SMUSDX(C2, R);
# 415 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
        T = read_q15x2 (pSi1);
        ...
        out1 = __SMUAD(C1, S) >> 16U;
        out2 = __SMUSDX(C1, S);
# 457 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
# 488 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  j = fftLen >> 2;
...
# 555 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  } while (--j);
# 965 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
}
# 1017 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
void arm_radix4_butterfly_inverse_q15(
        q15_t * pSrc16,
        uint32_t fftLen,
  const q15_t * pCoef16,
        uint32_t twidCoefModifier)
{
  ...
  do
  {
    ...
    out2 = __SMUADX(C2, R);
# 1123 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    T = read_q15x2 (pSi1);
    T = __SHADD16(T, 0);
    T = __SHADD16(T, 0);
    ...
    S = __QASX(S, T);
# 1153 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    C1 = read_q15x2 ((q15_t *) pCoef16 + (2U * ic));
    ...
    out2 = __SMUADX(C1, S);
# 1169 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    write_q15x2_ia (&pSi2, __extension__ ({ uint32_t __RES, __ARG1 = (out1), __ARG2 = (out2); __asm ("pkhbt %0, %1, %2, lsl %3" : "=r" (__RES) : "r" (__ARG1), "r" (__ARG2), "I" (0) ); __RES; }));
    ...
    out2 = __SMUADX(C3, R);
# 1188 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
    write_q15x2_ia (&pSi3, __extension__ ({ uint32_t __RES, __ARG1 = (out1), __ARG2 = (out2); __asm ("pkhbt %0, %1, %2, lsl %3" : "=r" (__RES) : "r" (__ARG1), "r" (__ARG2), "I" (0) ); __RES; }));
...
# 1202 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  twidCoefModifier <<= 2U;
  ...
  for (k = fftLen / 4U; k > 4U; k >>= 2U)
  {
    ...
    for (j = 0U; j <= (n2 - 1U); j++)
    {
      ...
      for (i0 = j; i0 < fftLen; i0 += n1)
      {
        ...
        out2 = __SMUADX(C2, R);
# 1281 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
        T = read_q15x2 (pSi1);
        ...
        out1 = __SMUSD(C1, S) >> 16U;
        out2 = __SMUADX(C1, S);
# 1321 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
        write_q15x2 (pSi2, __extension__ ({ uint32_t __RES, __ARG1 = (out1), __ARG2 = (out2); __asm ("pkhbt %0, %1, %2, lsl %3" : "=r" (__RES) : "r" (__ARG1), "r" (__ARG2), "I" (0) ); __RES; }));
        pSi2 += 2 * n1;
...
# 1351 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  j = fftLen >> 2;
  ...
  do
  {
    ...
    write_q15x2_ia (&ptr1, __SHSAX(S, U));
# 1418 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
  } while (--j);
# 1809 "C:\\Users\\mtatsumi\\Documents\\SEGGER Embedded Studio Projects\\e155-karaoke\\mcu\\lib\\arm_math\\dsp\\TransformFunctions\\arm_cfft_radix4_q15.c"
}
